...
public class AccountTests {
    ...
    public static void main(String args[]) {
        ...
        account01.withdraw(100, "Electricity bill");
        System.out.println("*Display Account Details*: ");
        System.out.println(account01);
        ...
        account01.withdraw(500, "Shopping");
        System.out.println("*Display Account Details*: ");
        System.out.println(account01);
        ...
        account02.withdraw(200, "Takeway");
        ...
        account03.withdraw(1000, "Home Decor");
